            ...
            <div class="main-sidebar">
                <aside id="sidebar-wrapper">
                    <div class="sidebar-brand">
                        <a href="index.html">Toko Kita 1637</a>
                    </div>
                    <div class="sidebar-brand sidebar-brand-sm">
                        <a href="index.html">St</a>
                    </div>
                    <ul class="sidebar-menu">
                        <li><a class="nav-link" href="<?php echo site_url('adminpanel/dashboard'); ?>"><i class="fa fa-fire"></i><span>Dashboard</span></a></li>
                        ...
                        <li class="nav-item dropdown">
                            ...
                            <ul class="dropdown-menu">
                                ...
                                <li><a class="nav-link" href="<?php echo site_url('ongkir'); ?>"><i class="fas fa-wallet"></i> Ongkor Kirim</a></li>
                            </ul>
                        </li>
                        <li><a class="nav-link" href="<?php echo site_url('member'); ?>"><i class="fa fa-user"></i><span>Member</span></a></li>
                        <li><a class="nav-link" href="<?php echo site_url('toko'); ?>"><i class="fa fa-store"></i><span>Kelola Toko</span></a></li>
                        <li><a class="nav-link" href="<?php echo site_url('feedback'); ?>"><i class="fa fa-heart"></i><span>Feedback Member</span></a></li>
                    </ul>
                </aside>
            </div>
