    ...
    <section class="section">
        ...
        <div class="section-body">
            ...
            <div class="row">
                ...
                <div class="col-md-9">
                    <div class="card">
                        <form method="POST" action="<?= site_url('detail_toko/edit') ?>" enctype="multipart/form-data" class="needs-validation" novalidate="">
                            <div class="card-header">
                                <h4>Produk Baru</h4>
                            </div>
                            <div class="card-body">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="custom-file">
                                        <img src="<?= base_url() ?>assets/img/<?= $produk->foto ?>" height="70px" width="70px">
                                    </div>
                                </div>
                                <div class="form-group">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" name="berat" class="form-control" required="" value="<?= $produk->berat ?>">
                                </div>
                                <div class="form-group">
                                    <label for="site-description" class="form-control-label">Deskripsi</label>
                                    <textarea class="form-control" name="deskripsiProduk" id="site-description"><?= $produk->deskripsiProduk ?></textarea>
                                </div>
                            </div>
                            <div class="card-footer text-right">
                                <a href="<?php echo base_url('detail_toko/produk'); ?>" class="btn btn-primary ">Kembali</a>
